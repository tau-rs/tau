...
pub use package::{
    ...
    GitLocation, HostName, HostNameError, NetCapability, PackageDep, PackageId, PackageKind,
    PackageManifest, PackageSource, PluginKind, PluginManifest, PluginRequiredTier,
    PluginSandboxRequirements, PortKind, ProcessCapability, SkillCapability, SkillFormat,
    SynthesizeError, UncheckedManifest,
};
pub use value::Value;
