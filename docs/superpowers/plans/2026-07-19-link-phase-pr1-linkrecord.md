...
- **Create** `docs/decisions/0059-build-links-verified-linkrecord.md` + **Modify** `docs/SUMMARY.md`.
...
### Task 6: ADR-0059 + SUMMARY.md

**Files:**
- Create: `docs/decisions/0059-build-links-verified-linkrecord.md`
...
Add the line `- [0059 — Build links; verified LinkRecord](decisions/0059-build-links-verified-linkrecord.md)` in the decisions list, after the 0058 entry.
...
```bash
git add docs/decisions/0059-build-links-verified-linkrecord.md docs/SUMMARY.md
git commit -m "docs(link): ADR-0059 — build links; verified LinkRecord; run trusts after verify"
```
...
- Deliverables: ADR-0059 + SUMMARY → Task 6. ✓
