...
**ADR:** 0064 (0057 is taken by open PR #423; 0058 is control-flow)
...
- **`hosts = ["*"]`**: none in any manifest/fixture (verified). Only prose ref is
  ...
  or add a one-line "superseded by 0064" note.
...
- **ADR 0064** — "one host semantic: exact + typed any; no derived hosts" — plus
