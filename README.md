...
| [ADR-0009](docs/adr/0009-entry-freeze.md) | The `Entry` freeze: the twelve log kinds join the frozen directory, and `ABI` 2 is the first number that names the line format |
